		...
		<form action="javascript:void(0);" onsubmit="return saveCriteria()" class="w3-container w3-margin" id="addRubForm">
			...
			<div class="w3-container w3-margin-16">
				...
				<div class="criteriaForm" id="removeForm_1">
                    ...
                    <div class="w3-row">
					  <div class="w3-col m3 l3 w3-padding"><b class="w3-right w3-hide-small w3-large"><span class="w3-text-red">*</span> Percentage:</b><b class="w3-left w3-hide-large w3-hide-medium w3-large"><span class="w3-text-red">*</span> Percentage:</b></div>
						<div class="w3-col s12 l9 m9">
							<input type='number' min="1" max="100" name="percentage[]" id="percentage[]" class="w3-input w3-border" required />	
						</div>
					</div>
				</div>
