		...
		<form action="javascript:void(0);" onsubmit="return saveCriteria()" class="w3-container w3-margin">
			...
			<div class="w3-container w3-margin-16">
				...
				<div class="criteriaForm" id="removeForm_1">
					<div class="w3-row">
					<a href="#" style="text-decoration:none;" onclick="removeForm(1);" class="w3-right w3-text-red"><i class="fa fa-remove fa-fx"></i> Remove</a>
